    ...
    <header className="bg-blue-600 text-white py-4 shadow-md sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center px-6 lg:px-12">
        ...
        <nav className="flex items-center space-x-6">
          ...
          {currentUser && (
            <Link to="/cart" onClick={handleCartClick} className="relative hover:text-blue-300 transition">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
          ...
          {currentUser ? (
            ...
            <>
              <Link to="/login" className="bg-blue-500 hover:bg-blue-400 text-white py-1 px-4 rounded-lg transition">
                Log In
              </Link>
              <Link
                to="/signup"
